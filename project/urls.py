...
urlpatterns = patterns('',
    ...
    url(r'^neighborhood_analysis/(?P<field>[_a-z]+)$', NeighborhoodAnalysis.as_view(), name='neighborhood_analysis'),
    url(r'^neighborhood_analysis/$', NeighborhoodAnalysis.as_view(), name='neighborhood_analysis'),
    ...
    url(r'^api/neighborhoods.json$', neighborhoods_json, name='neighborhoods-json'),
