...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'building_and_safety_censustract', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tract_id', self.gf('django.db.models.fields.CharField')(max_length=11)),
            ('polygon_4326', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'building_and_safety', ['CensusTract'])


    def backwards(self, orm):
        # Deleting model 'CensusTract'
        db.delete_table(u'building_and_safety_censustract')
