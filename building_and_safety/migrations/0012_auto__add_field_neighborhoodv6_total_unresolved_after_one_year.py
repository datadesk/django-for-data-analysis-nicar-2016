...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NeighborhoodV6.total_unresolved_after_one_year'
        db.add_column(u'building_and_safety_neighborhoodv6', 'total_unresolved_after_one_year',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NeighborhoodV6.total_unresolved_after_one_year'
        db.delete_column(u'building_and_safety_neighborhoodv6', 'total_unresolved_after_one_year')
