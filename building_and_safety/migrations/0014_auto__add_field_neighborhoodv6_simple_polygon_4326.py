...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NeighborhoodV6.simple_polygon_4326'
        db.add_column(u'building_and_safety_neighborhoodv6', 'simple_polygon_4326',
                      self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NeighborhoodV6.simple_polygon_4326'
        db.delete_column(u'building_and_safety_neighborhoodv6', 'simple_polygon_4326')
