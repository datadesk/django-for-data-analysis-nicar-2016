...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Complaint.address_street_zip'
        db.alter_column(u'building_and_safety_complaint', 'address_street_zip', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

        # Changing field 'Complaint.address_house_number'
        db.alter_column(u'building_and_safety_complaint', 'address_house_number', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Complaint.address_street_zip'
        db.alter_column(u'building_and_safety_complaint', 'address_street_zip', self.gf('django.db.models.fields.IntegerField')(default=None))

        # Changing field 'Complaint.address_house_number'
        db.alter_column(u'building_and_safety_complaint', 'address_house_number', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Complaint.csr_priority'
        db.alter_column(u'building_and_safety_complaint', 'csr_priority', self.gf('django.db.models.fields.IntegerField')(default=None))
