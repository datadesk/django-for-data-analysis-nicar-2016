...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Complaint.housing_dept_related'
        db.add_column(u'building_and_safety_complaint', 'housing_dept_related',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Complaint.housing_dept_related'
        db.delete_column(u'building_and_safety_complaint', 'housing_dept_related')
