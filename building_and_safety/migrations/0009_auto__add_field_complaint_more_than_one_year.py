...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Complaint.more_than_one_year'
        db.add_column(u'building_and_safety_complaint', 'more_than_one_year',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Complaint.more_than_one_year'
        db.delete_column(u'building_and_safety_complaint', 'more_than_one_year')
