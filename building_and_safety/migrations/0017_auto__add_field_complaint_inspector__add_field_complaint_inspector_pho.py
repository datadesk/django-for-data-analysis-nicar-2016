...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Complaint.inspector'
        db.add_column(u'building_and_safety_complaint', 'inspector',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Complaint.inspector_phone_number'
        db.add_column(u'building_and_safety_complaint', 'inspector_phone_number',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Complaint.notes'
        db.add_column(u'building_and_safety_complaint', 'notes',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Complaint.inspector'
        db.delete_column(u'building_and_safety_complaint', 'inspector')

        # Deleting field 'Complaint.inspector_phone_number'
        db.delete_column(u'building_and_safety_complaint', 'inspector_phone_number')

        # Deleting field 'Complaint.notes'
        db.delete_column(u'building_and_safety_complaint', 'notes')
