...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Complaint.address_house_fraction'
        db.alter_column(u'building_and_safety_complaint', 'address_house_fraction', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

    def backwards(self, orm):

        # Changing field 'Complaint.address_house_fraction'
        db.alter_column(u'building_and_safety_complaint', 'address_house_fraction', self.gf('django.db.models.fields.CharField')(max_length=3, null=True))
