...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InspectionDistrict.csr1_complaints'
        db.add_column(u'building_and_safety_inspectiondistrict', 'csr1_complaints',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'InspectionDistrict.csr2_complaints'
        db.add_column(u'building_and_safety_inspectiondistrict', 'csr2_complaints',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'InspectionDistrict.csr3_complaints'
        db.add_column(u'building_and_safety_inspectiondistrict', 'csr3_complaints',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'InspectionDistrict.median_wait_csr1'
        db.add_column(u'building_and_safety_inspectiondistrict', 'median_wait_csr1',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'InspectionDistrict.median_wait_csr2'
        db.add_column(u'building_and_safety_inspectiondistrict', 'median_wait_csr2',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'InspectionDistrict.median_wait_csr3'
        db.add_column(u'building_and_safety_inspectiondistrict', 'median_wait_csr3',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InspectionDistrict.csr1_complaints'
        db.delete_column(u'building_and_safety_inspectiondistrict', 'csr1_complaints')

        # Deleting field 'InspectionDistrict.csr2_complaints'
        db.delete_column(u'building_and_safety_inspectiondistrict', 'csr2_complaints')

        # Deleting field 'InspectionDistrict.csr3_complaints'
        db.delete_column(u'building_and_safety_inspectiondistrict', 'csr3_complaints')

        # Deleting field 'InspectionDistrict.median_wait_csr1'
        db.delete_column(u'building_and_safety_inspectiondistrict', 'median_wait_csr1')

        # Deleting field 'InspectionDistrict.median_wait_csr2'
        db.delete_column(u'building_and_safety_inspectiondistrict', 'median_wait_csr2')

        # Deleting field 'InspectionDistrict.median_wait_csr3'
        db.delete_column(u'building_and_safety_inspectiondistrict', 'median_wait_csr3')
