...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InspectionDistrict.median_wait'
        db.add_column(u'building_and_safety_inspectiondistrict', 'median_wait',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'InspectionDistrict.mean_wait'
        db.add_column(u'building_and_safety_inspectiondistrict', 'mean_wait',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InspectionDistrict.median_wait'
        db.delete_column(u'building_and_safety_inspectiondistrict', 'median_wait')

        # Deleting field 'InspectionDistrict.mean_wait'
        db.delete_column(u'building_and_safety_inspectiondistrict', 'mean_wait')
