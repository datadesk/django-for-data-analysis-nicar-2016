...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Complaint.date_received'
        db.alter_column(u'building_and_safety_complaint', 'date_received', self.gf('django.db.models.fields.DateField')(null=True))
        # Removing index on 'Complaint', fields ['date_received']
        db.delete_index(u'building_and_safety_complaint', ['date_received'])


        # Changing field 'Complaint.response_days'
        db.alter_column(u'building_and_safety_complaint', 'response_days', self.gf('django.db.models.fields.CharField')(max_length=4, null=True))

        # Changing field 'Complaint.csr_priority'
        db.alter_column(u'building_and_safety_complaint', 'csr_priority', self.gf('django.db.models.fields.CharField')(max_length=1, null=True))

    def backwards(self, orm):
        # Adding index on 'Complaint', fields ['date_received']
        db.create_index(u'building_and_safety_complaint', ['date_received'])


        # Changing field 'Complaint.date_received'
        db.alter_column(u'building_and_safety_complaint', 'date_received', self.gf('django.db.models.fields.DateField')(default=None))

        # Changing field 'Complaint.response_days'
        db.alter_column(u'building_and_safety_complaint', 'response_days', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Complaint.csr_priority'
        db.alter_column(u'building_and_safety_complaint', 'csr_priority', self.gf('django.db.models.fields.IntegerField')(null=True))
