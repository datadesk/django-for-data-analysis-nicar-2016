...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Complaint.days_since_complaint'
        db.add_column(u'building_and_safety_complaint', 'days_since_complaint',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


        # Changing field 'Complaint.area_planning_commission'
        db.alter_column(u'building_and_safety_complaint', 'area_planning_commission', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

    def backwards(self, orm):
        # Deleting field 'Complaint.days_since_complaint'
        db.delete_column(u'building_and_safety_complaint', 'days_since_complaint')


        # Changing field 'Complaint.area_planning_commission'
        db.alter_column(u'building_and_safety_complaint', 'area_planning_commission', self.gf('django.db.models.fields.CharField')(max_length=12, null=True))
