...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Complaint.past_due_date'
        db.add_column(u'building_and_safety_complaint', 'past_due_date',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Complaint.days_past_due_date'
        db.add_column(u'building_and_safety_complaint', 'days_past_due_date',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Complaint.past_due_date'
        db.delete_column(u'building_and_safety_complaint', 'past_due_date')

        # Deleting field 'Complaint.days_past_due_date'
        db.delete_column(u'building_and_safety_complaint', 'days_past_due_date')
