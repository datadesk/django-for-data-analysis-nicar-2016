...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InspectionDistrict.complaints'
        db.add_column(u'building_and_safety_inspectiondistrict', 'complaints',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InspectionDistrict.complaints'
        db.delete_column(u'building_and_safety_inspectiondistrict', 'complaints')
