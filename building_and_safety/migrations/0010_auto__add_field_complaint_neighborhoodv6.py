...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Complaint.neighborhoodv6'
        db.add_column(u'building_and_safety_complaint', 'neighborhoodv6',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['building_and_safety.NeighborhoodV6'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Complaint.neighborhoodv6'
        db.delete_column(u'building_and_safety_complaint', 'neighborhoodv6_id')
