...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InspectionDistrict'
        db.create_table(u'building_and_safety_inspectiondistrict', (
        ...
        db.send_create_signal(u'building_and_safety', ['InspectionDistrict'])


    def backwards(self, orm):
        # Deleting model 'InspectionDistrict'
        db.delete_table(u'building_and_safety_inspectiondistrict')
