...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NeighborhoodV6.total_complaints'
        db.add_column(u'building_and_safety_neighborhoodv6', 'total_complaints',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'NeighborhoodV6.open_complaints'
        db.add_column(u'building_and_safety_neighborhoodv6', 'open_complaints',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'NeighborhoodV6.closed_complaints'
        db.add_column(u'building_and_safety_neighborhoodv6', 'closed_complaints',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'NeighborhoodV6.open_over_one_year'
        db.add_column(u'building_and_safety_neighborhoodv6', 'open_over_one_year',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'NeighborhoodV6.closed_over_one_year'
        db.add_column(u'building_and_safety_neighborhoodv6', 'closed_over_one_year',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'NeighborhoodV6.percent_over_one_year_to_response'
        db.add_column(u'building_and_safety_neighborhoodv6', 'percent_over_one_year_to_response',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)

        # Adding field 'NeighborhoodV6.avg_days_to_response'
        db.add_column(u'building_and_safety_neighborhoodv6', 'avg_days_to_response',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NeighborhoodV6.total_complaints'
        db.delete_column(u'building_and_safety_neighborhoodv6', 'total_complaints')

        # Deleting field 'NeighborhoodV6.open_complaints'
        db.delete_column(u'building_and_safety_neighborhoodv6', 'open_complaints')

        # Deleting field 'NeighborhoodV6.closed_complaints'
        db.delete_column(u'building_and_safety_neighborhoodv6', 'closed_complaints')

        # Deleting field 'NeighborhoodV6.open_over_one_year'
        db.delete_column(u'building_and_safety_neighborhoodv6', 'open_over_one_year')

        # Deleting field 'NeighborhoodV6.closed_over_one_year'
        db.delete_column(u'building_and_safety_neighborhoodv6', 'closed_over_one_year')

        # Deleting field 'NeighborhoodV6.percent_over_one_year_to_response'
        db.delete_column(u'building_and_safety_neighborhoodv6', 'percent_over_one_year_to_response')

        # Deleting field 'NeighborhoodV6.avg_days_to_response'
        db.delete_column(u'building_and_safety_neighborhoodv6', 'avg_days_to_response')
