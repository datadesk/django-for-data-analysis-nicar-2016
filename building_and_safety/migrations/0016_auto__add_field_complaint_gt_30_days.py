...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Complaint.gt_30_days'
        db.add_column(u'building_and_safety_complaint', 'gt_30_days',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Complaint.gt_30_days'
        db.delete_column(u'building_and_safety_complaint', 'gt_30_days')
