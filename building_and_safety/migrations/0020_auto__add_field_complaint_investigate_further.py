...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Complaint.investigate_further'
        db.add_column(u'building_and_safety_complaint', 'investigate_further',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Complaint.investigate_further'
        db.delete_column(u'building_and_safety_complaint', 'investigate_further')
